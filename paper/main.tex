...
identifying a 6-feature minimal predictor set (alive-AUC cross-validated
$R^2=0.257$; best single-target held-out $R^2=0.668$ for regulation quality).
...
percentage-decline scales, all six sub-additive pairs remain
sub-additive (bootstrap 95\% CI excludes zero for 5/6 pairs).
...
ecology stressor protocol~(§S2), and phenotype clustering
validation~(§S3).}
...
$d$=1.42 ($\delta$=0.66) at 10,000 steps, confirming that adaptation
