...
Code and data: anonymized repository (DOI upon acceptance).
Future: larger populations for open-ended evolution
\citep{bedau_2000_open,taylor_2016_openended}; Level~4 evolution via extended
runs.
