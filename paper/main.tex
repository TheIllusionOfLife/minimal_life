...
\caption{Left: PCA biplot (PC1=38\%, PC2=31\%; full-criteria vs.\ all-off at
opposite poles; pairwise ablations cluster near all-off).
Right: criterion Pareto curve (all $R^2<0$; underpowered; Enet rankings are
primary evidence).}
