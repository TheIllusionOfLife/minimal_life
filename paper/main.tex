...
A fully seed-disjoint split would require additional simulation runs beyond
our current data; the regime-based generalization design ensures that the
primary independence axis (environment parameters) is strictly separated.
...
VIF screening was applied in Phase~1 (14$\to$6 features); Phase~2 used an
expanded 12-feature set and relied on LASSO/Elastic Net stability selection
for implicit regularization of collinearity.
