...
Excluding \texttt{alive\_auc}, the remaining 11 surrogates achieve validation
$R^2=0.941$ and test $R^2=0.845$ (LASSO, same protocol), indicating that
predictive power does not depend on the near-tautological alive-count proxy
alone.
...
cluster-robust CI $[0.706, 0.785]$ ($n_{\text{seeds}}=30$), both excluding zero,
