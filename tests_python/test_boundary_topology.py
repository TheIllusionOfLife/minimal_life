        ...
        for topo in topologies:
            for cond in conditions:
                for seed in range(100, 105):
                    ...
                    # Add per-seed jitter to avoid degenerate MW tests
                    jitter = seed - 102  # range: -2, -1, 0, 1, 2
                    if cond == "normal":
                        alive = (80 if topo == "toroidal" else 60) + jitter
                    elif cond == "no_metabolism":
                        alive = max(1, (5 if topo == "toroidal" else 3) + jitter)
                    elif cond == "no_reproduction":
                        alive = (40 if topo == "toroidal" else 30) + jitter
                    else:
                        alive = (30 if topo == "toroidal" else 20) + jitter
